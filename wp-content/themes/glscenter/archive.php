	...
	<div class="post_header_container"><h1>Archives</h1></div>
		...
		<?php if (have_posts()) : ?>
			...
			<?php /* If this is a category archive */ if (is_category()) { ?>
				<center><h2>Archive for the &#8216;<?php single_cat_title(); ?>&#8217; Category</h2></center>

			<?php /* If this is a tag archive */ } elseif( is_tag() ) { ?></center>
				<center><h2>Posts Tagged &#8216;<?php single_tag_title(); ?>&#8217;</h2></center>

			<?php /* If this is a daily archive */ } elseif (is_day()) { ?>
				<center><h2>Archive for <?php the_time('F jS, Y'); ?></h2></center>

			<?php /* If this is a monthly archive */ } elseif (is_month()) { ?>
				<center><h2>Archive for <?php the_time('F, Y'); ?></h2></center>
